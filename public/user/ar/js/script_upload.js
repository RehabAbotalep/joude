...
$(document).ready(function($) {
    ...
    $('.bankimg').each(function() {
        $(this).hide();
        $(this).after('<div class="file-container file-containerbank"><a href="javascript:void(0);" class="button-file">' + $(this).attr('data-value') + '</a><span class="file-name">  إرفاق صورة التحويل البنكى  </span></div>');
    });
