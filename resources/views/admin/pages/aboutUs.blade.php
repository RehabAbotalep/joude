...
<div class="wrapper_cols">
  <div class="col_page_content">
    <div class="row">
      <div class="col-md-12">
        <h5>{{trans('messages.about.page')}}</h5>
      </div>
      <!--row-->
    </div>
    <div class="row">
          ...
          <div class="row">
            ...
            <form action="{{route('aboutus.update')}}" method="post">
              ...
              <div class="form-group col-md-12">
                <textarea id="summernote1" name="content_ar" required>{{$aboutUs->content_ar}}</textarea>
              </div>

              <div class="form-group col-md-12">
                <textarea id="summernote2" name="content_en" required>{{$aboutUs->content_en}}</textarea>
              </div>
