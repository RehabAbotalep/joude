        ...
        <div class="row">
            <div class="col-md-12" >
                <div class="blog_tablesearch">
                    <h5>{{trans('messages.city.add')}}</h5><br><br>
    ...
    <div class="col-md-12">
        <div class="blog_tablesearch">
            <div class="table-responsive">
                <table id="example" class="table table_brands table-striped table-bordered display nowrap" style="width:100%">
                    <thead>
                        <th>{{trans('messages.number')}}</th>
                        <th>{{trans('messages.name')}}</th>
                        <th>{{trans('messages.regions')}}</th>
