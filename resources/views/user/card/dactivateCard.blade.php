            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="titlepages title_style">
                        <h2><a href="{{ route('home') }}"><i class="fa fa-home"></i> / </a> {{ trans('messages.card.turnoff') }}</h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title_style">
                        <div class="title">{{ trans('messages.card.turnoff') }}</div>
                        <div class="decor"><span></span></div>
                    </div>
                    <!--title_style-->
                </div>
                    ...
                    <div class="login_blog">
                        <div class="code_page">
                            <div class="form_code">
                                ...
                                @endif
                                <form method="POST" action="{{ route('deactivate.card.confirm') }}">
                                	@csrf
